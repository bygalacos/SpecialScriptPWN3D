...
DisplayError.fadeDuration = 1000;
class ErrorObject {
    constructor(obj) {
        this.obj = obj;
    }
...
class Bots {
        ...
        if (!Bots.createBotCard) {
            Bots.createBotCard = createElement("div", { class: "formbox flex flexhorizontal" },
                createElement("div", { class: "flexmax flex flexvertical", onclick: () => this.CardQuickConnectBot() },
                    ...
                    createElement("div", { class: "flexmax imageCard", style: "background-image: url(media/icons/plus.svg)" })));
        }
            ...
            createElement("div", { class: "formcontent" },
                ...
                createElement("div", { class: "flex2" },
                    createElement("div", null,
                        createElement("a", { when: botInfo.Status === BotStatus.Connected, class: "jslink button buttonMedium", href: "index.html?page=bot.html&bot_id=" + botInfo.Id, style: "background-image: url(media/icons/list-rich.svg)" })),
                    createElement("div", { when: botInfo.Name === null && botInfo.Id !== null, class: "button buttonMedium", style: "background-image: url(media/icons/paperclip.svg)", onclick: () => this.CardSaveBot(botInfo.Id) }),
                    createElement("div", { when: botInfo.Name !== null, class: "button buttonMedium", style: "background-image: url(media/icons/trash.svg)", onclick: () => this.CardDeleteBot(botInfo.Name) }),
                    createElement("div", { class: "button buttonRound buttonMedium " + (botInfo.Status === BotStatus.Offline ? "buttonGreen" : "buttonRed"), set: divStartStopButton, style: "background-image: url(media/icons/" + (botInfo.Status === BotStatus.Offline ? "play-circle" : "power-standby") + ".svg)", onclick: (e) => this.CardStartStop(botInfo, e, div) }))));
        if (oldDiv !== undefined) {
    ...
    CardDeleteBot(name) {
        return __awaiter(this, void 0, void 0, function* () {
            yield ModalBox.show("Botu gerçekten silmek istiyor musun?", "Botu sil: " + name, {}, {
                text: "Evet",
                default: true,
    ...
    CardQuickConnectBot() {
        return __awaiter(this, void 0, void 0, function* () {
            yield ModalBox.show("", "Yeni Bot Oluştur", {
                inputs: { address: "İp Adresi Girin" }
            }, {
                text: "Ok",
                default: true,
    ...
    CardSaveBot(botId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield ModalBox.show("", "Save bot", {
                inputs: { name: "Yeni Kayıt İsmi" }
            }, {
                text: "Ok",
                default: true,
                action: (i) => __awaiter(this, void 0, void 0, function* () {
...
class Home {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Util.getElementByIdSafe("data_branch").innerText = res.Website;
            Util.getElementByIdSafe("data_commit").innerText = res.Developer;
            this.ticker.start();
        });
    }
    refresh() {
...
class PlayControls {
    constructor() {
        ...
        this.divRandom.onclick = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield bot(jmerge(cmd("random", (!this.random) ? "on" : "off"), cmd("random"))).get();
        ...
        this.divNext.onclick = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!DisplayError.check(res, "İleri atlanamadı"))
                return;
            this.startEcho();
        });
        this.divPrev.onclick = () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!DisplayError.check(res, "Geri atlanamadı"))
                return;
            this.startEcho();
        });
    ...
    showStatePlaying(song, playing = song ? PlayState.Playing : PlayState.Off) {
        if (song !== null) {
            ...
            this.currentSong = null;
            this.divNowPlaying.innerText = "Çalmıyor...";
        }
