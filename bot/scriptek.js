        ...
        if (!Bots.createBotCard) {
            Bots.createBotCard = createElement("div", { class: "formbox flex flexhorizontal" },
                ...
                createElement("div", { class: "flexmax flex flexvertical", onclick: () => this.CardQuickConnectBot() },
                    createElement("div", { class: "formheader centerText", style: "display: none" }, "Bot Oluştur"),
        ...
        const div = createElement("div", { class: "botCard formbox" + statusIndicator },
            ...
            createElement("div", { class: "formcontent" },
                ...
                createElement("div", { class: "flex2" },
                    ...
                    createElement("div", { when: botInfo.Name !== null, class: "button buttonMedium", style: "display: none", onclick: () => this.CardCopyBot(botInfo.Name) }),
                    createElement("div", { when: botInfo.Name !== null, class: "button buttonMedium", style: "display: none", onclick: () => this.CardDeleteBot(botInfo.Name) }),
